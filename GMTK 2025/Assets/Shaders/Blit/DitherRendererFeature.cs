...
public class BlitAndSwapColorPass : ScriptableRenderPass
{
    ...
    public override void RecordRenderGraph(RenderGraph renderGraph, ContextContainer frameData)
    {
        ...
        var desc = new RenderTextureDescriptor(480, 270, RenderTextureFormat.Default, 0);

        //var desc = source.GetDescriptor(renderGraph);
        //desc.width = 500;

        TextureHandle destination = UniversalRenderer.CreateRenderGraphTexture(renderGraph, desc, "My Texture", false);
